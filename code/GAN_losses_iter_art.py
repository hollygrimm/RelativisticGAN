...
parser.add_argument('--input_folder', default='/home/ubuntu/datasets/meow_128x128', help='input folder')
parser.add_argument('--output_folder', default='/home/ubuntu/RelativisticGAN/output', help='output folder')
parser.add_argument('--inception_folder', default='/home/ubuntu/models/Inception', help='Inception model folder (path must exists already, model will be downloaded automatically)')
...
parser.add_argument('--loss_D', type=int, default=7, help='Loss of D, see code for details (1=GAN, 2=LSGAN, 3=WGAN-GP, 4=HingeGAN, 5=RSGAN, 6=RaSGAN, 7=RaLSGAN, 8=RaHingeGAN)')
...
parser.add_argument('--gen_extra_images', type=int, default=2000, help='Generate additional images with random fake cats in calculating FID (Recommended to use the same amount as the size of the dataset; for CIFAR-10 we use 50k, but most people use 10k) It must be a multiple of 100.')
parser.add_argument('--gen_every', type=int, default=2000, help='Generate additional images with random fake cats every x iterations. Used in calculating FID.')
...
parser.add_argument('--CIFAR10_input_folder', default='/home/ubuntu/datasets/CIFAR10', help='input folder (automatically downloaded)')
